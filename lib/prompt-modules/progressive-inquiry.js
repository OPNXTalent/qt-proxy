...

{
  ...
  "canonical_response": "A complete, direct, standalone response in polished prose. It must preserve the full epistemic quality of The Prism while excluding optional Framework exposition. Use semantic paragraphing whenever the response develops more than one material thought: begin a new paragraph when the reasoning moves between premise, evidence, qualification, complication, implication, or conclusion. Most paragraphs should be roughly 2–5 sentences. Do not manufacture one-sentence fragments, excessive headings, or arbitrary breaks merely for appearance. Never collapse a long response into one contiguous block. Separate natural paragraphs with a blank line so the renderer preserves the intended breathing room. On an initial inquiry, end with one query-derived open door only when it is load-bearing.",
