...

{
  ...
  "open_door_question": "REQUIRED on every response from this initial-query endpoint as a compatibility mirror of the one closing question already written as the final sentence of core_insight. It must pass the SOURCE, NECESSITY, and SPECIFICITY tests. Never return an empty string. Never use a generic engagement prompt, coaching formula, feature invitation, reusable sign-off, or invitation to inspect the framework. The renderer must not display this field as a separate callout or duplicate a question already present in core_insight.",
