...
for (const event of ['response_delta', 'canonical_complete', 'interpretive_context', 'explore_context', 'done']) {
...
assert.ok(initial.indexOf("type: 'canonical_complete'") < initial.indexOf('generateAndAttachContext'));
